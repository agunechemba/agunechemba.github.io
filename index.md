...
<audio autoplay loop volume="0.2">
  <source src="https://audio.com/chello/audio/celtic-reggae" type="audio/mp3">
...
<div class="container">
  ...
  <h1><i class="fas fa-laptop-code"></i> <br> Agunechemba Ekene</h1>
  ...
  <p>As a side hustle, I also handle <strong>web administration</strong> and have hosted sites like <em>surepath.ng, clasamenergy.com, clasamschools.com</em>, and managed <strong>business email hosting</strong> for various clients.</p>

  <p>I love sharing tech tips and tricks in my <a href="#my-blog">blog</a>.</p>

  <p>Right now, I'm having a ton of fun <a href="#my-blog">blogging</a>, training, and teaching computer programming at 
